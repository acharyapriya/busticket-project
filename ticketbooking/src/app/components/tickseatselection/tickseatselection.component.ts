...
@Input() seatconfig:any;
  ...
  ngOnInit(): void {
    console.log(this.bookedid)
     this.ticketSchedule=localStorage.getItem("ticketschedule");
  //  this.ticketbooking.getticketDetails(this.ticketSchedule).subscribe((data)=>{
  //    console.log(data,"sbjsjdjs")
